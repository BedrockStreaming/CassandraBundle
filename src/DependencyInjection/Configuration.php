                    ...
                    ->prototype('array')
                        ...
                        ->children()
                            ...
                            ->arrayNode('retries')
                                ...
                                ->end()
                            ->end()
                            ->integerNode('io_threads')->defaultValue(1)->end()
                            ->integerNode('connections_per_host_core')->defaultValue(1)->end()
                            ->integerNode('connections_per_host_max')->defaultValue(2)->end()
                        ->end()
                    ->end()
                ->end()
            ->end();
